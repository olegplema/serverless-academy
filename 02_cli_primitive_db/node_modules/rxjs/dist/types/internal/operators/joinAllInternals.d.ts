...
import { ObservableInput } from 'rxjs/dist/types/internal/types';
/**
 ...
 */
export declare function joinAllInternals<T, R>(joinFn: (sources: ObservableInput<T>[]) => Observable<T>, project?: (...args: any[]) => R): import("rxjs/dist/types/internal/types").UnaryFunction<Observable<ObservableInput<T>>, unknown>;
